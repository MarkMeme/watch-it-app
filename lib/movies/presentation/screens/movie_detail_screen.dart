...
import 'package:watch_it_app/core/network/api_constants.dart';
import 'package:watch_it_app/core/services/services_locator.dart';
import 'package:watch_it_app/movies/presentation/cotroller/movie_details_bloc.dart';
...
class MovieDetailContent extends StatelessWidget {
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
        builder: (context, state) {
      print(state.recommendation.length);
